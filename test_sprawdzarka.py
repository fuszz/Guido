...
class MyTestCase(unittest.TestCase):
    def test_czy_glosy_w_skalach_1(self):
        ...
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_w_swoich_skalach(a_test),
                         [dzwieki_w_skalach.DzwiekiWSkalach.W_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.PONIZEJ_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.W_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.PONIZEJ_SKALI])
    ...
    def test_czy_glosy_w_skalach_3(self):
        ...
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_w_swoich_skalach(a_test),
                         [dzwieki_w_skalach.DzwiekiWSkalach.W_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.PONIZEJ_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.W_SKALI,
                          dzwieki_w_skalach.DzwiekiWSkalach.POWYZEJ_SKALI])
    ...
    def test_czy_glosy_nie_skrzyzowane_2(self):
        ...
        ds = dzwiek.Dzwiek(4, 'c')
        a_test = akord.Akord(ds, da, dt, db, 1.0)
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_nie_skrzyzowane(a_test), [krzyzowania_glosow.KrzyzowaniaGlosow.SOPRAN_I_BAS,
                                                                                     krzyzowania_glosow.KrzyzowaniaGlosow.ALT_I_BAS,
                                                                                     krzyzowania_glosow.KrzyzowaniaGlosow.TENOR_I_BAS])
    ...
    def test_czy_glosy_nie_skrzyzowane_4(self):
        ...
        ds = dzwiek.Dzwiek(4, 'c')
        a_test = akord.Akord(ds, da, dt, db, 1.0)
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_nie_skrzyzowane(a_test), [krzyzowania_glosow.KrzyzowaniaGlosow.SOPRAN_I_ALT])
    ...
    def test_czy_glosy_sa_stopniami_tonacji_2(self):
        ...
        ds = dzwiek.Dzwiek(4, 'a')
        a_test = akord.Akord(ds, da, dt, db, 1.0)
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_sa_stopniami_tonacji(a_test, tonacja.Tonacja('C')), [niepoprawne_stopnie.NiepoprawneStopnie.ALT,
                                                                                                                niepoprawne_stopnie.NiepoprawneStopnie.BAS])
    ...
    def test_czy_glosy_sa_stopniami_tonacji_3(self):
        ...
        a_test = akord.Akord(ds, da, dt, db, 1.0)
        self.assertEqual(sprawdzarka.Sprawdzarka.czy_glosy_sa_stopniami_tonacji(a_test, tonacja.Tonacja('C#')), [
                                                                                            niepoprawne_stopnie.NiepoprawneStopnie.SOPRAN,
                                                                                            niepoprawne_stopnie.NiepoprawneStopnie.ALT,
                                                                                            niepoprawne_stopnie.NiepoprawneStopnie.TENOR,
                                                                                            niepoprawne_stopnie.NiepoprawneStopnie.BAS
                                                                                            ])
