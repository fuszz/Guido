...
def wyswietl_sygn_akordow_gdzie_glosy_poza_skalami(badana_partytura: Partytura) -> bool:
    ...
    if not wynik:
        ...
        print(f"{ow.BLAD} WYSTĘPUJĄ w akordach nr :", ow.sygn_i_glosy_w_str(wynik),  f"{ow.NORMALNY}")
        return False
...
def wyswietl_sygn_akordow_nietwarzacych_funkcji(badana_partytura: Partytura) -> bool:
    ...
    if not wynik:
        ...
        print(f"{ow.BLAD} WYSTĘPUJĄ w akordach nr :", ow.sygn_akordow_w_str(wynik), f"{ow.NORMALNY}")
        return False
...
def wyswietl_sygnatura_i_glosy_gdzie_przekroczone_odleglosci(badana_partytura: Partytura) -> bool:
    ...
    if not wynik:
        ...
        print(f"{ow.BLAD} WYSTĘPUJĄ w głosach akordów nr :", ow.sygn_i_glosy_w_str(wynik), f"{ow.NORMALNY}")
        return False
