...
class MyTestCase(unittest.TestCase):
    ...
    def test_podaj_metrum_1(self):
        ...
        p1 = partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('C'), enum_metrum.Metrum("3/4"), 2)
        self.assertEqual(p1.podaj_metrum(), enum_metrum.Metrum.TRZY_CZWARTE)

    def test_podaj_metrum_2(self):
        p1 = partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('C'), enum_metrum.Metrum("4/4"), 2)
    ...
    def test_konstruktora_1(self):
        ...
        try:
            partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('C'), enum_metrum.Metrum("3/4"), 2)
        except blad.BladTworzeniaPartytury:
    ...
    def test_podaj_tonacje_1(self):
        p1 = partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('C'), enum_metrum.Metrum("3/4"), 1)
        self.assertEqual(p1.podaj_tonacje().podaj_symbol(), tonacja.Tonacja.stworz_z_symbolu('C').podaj_symbol())
        del p1
    ...
    def test_podaj_zadeklarowana_liczbe_taktow(self):
        ...
        p1 = partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('C'), enum_metrum.Metrum("3/4"), 9)
    ...
    def test_podaj_liste_akordow_1(self):
        ...
        p2 = partytura.Partytura(tonacja.Tonacja.stworz_z_symbolu('D'), enum_metrum.Metrum("3/4"), 3)
