...
class TestInterwal(unittest.TestCase):
    def test_podaj_interwal_test1(self):
        dzwiek_a = Dzwiek(2, 'c')
        dzwiek_b = Dzwiek(2, 'd')
        self.assertEqual(Interwal(0, NazwyInterwalow.SEKUNDA_WIELKA),
    ...
    def test_podaj_interwal_test4(self):
        dzwiek_a = Dzwiek(3, 'c')
        dzwiek_b = Dzwiek(4, 'd')
        self.assertEqual(NazwyInterwalow.SEKUNDA_WIELKA,
                         Interwal.stworz_z_dzwiekow(dzwiek_a, dzwiek_b, Tonacja.A_MOLL).podaj_interwal())
