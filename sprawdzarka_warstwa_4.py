...
def sygn_i_glosy_z_polaczeniem_kwintami_rownoleglymi(badana_partytura: partytura.Partytura) -> list[(int, int, str)]:
...
def sygn_i_glosy_z_polaczeniem_oktawami_rownoleglymi(badana_partytura: partytura.Partytura) -> list[(int, int, str)]:
...
def sygn_i_glosy_gdzie_ruch_o_zbyt_duzy_interwal(badana_partytura: partytura.Partytura) -> list[(int, int, str)]:
